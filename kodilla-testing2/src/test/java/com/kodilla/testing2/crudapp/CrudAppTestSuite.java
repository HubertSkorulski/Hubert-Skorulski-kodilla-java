...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://huubsoon.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("hubertskorulski@gmail.com");		        // [3]
        driverTrello.findElement(By.id("password")).sendKeys("Misiek1!");		    // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                                // [5]

        Thread.sleep(4000);								                            // [6]

        driverTrello.findElement(By.id("password")).sendKeys("Misiek1!");		    // [7]
    ...
    private void deleteTaskFromCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> { deleteButton.click();
                });
        Thread.sleep(2000);
    }
